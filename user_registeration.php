...
if(isset($_GET['createaccount']))
{
	...
	$query = "INSERT INTO users(fname,	lname,	email,	password,	phone,	country,	business_name,	business_description, business_phone,	business_email,	business_website,	whatsapp,	instagram,	twitter,	facebook,	location) VALUES('$firstname','$lastname','$email','$password','$phone','$country','$businessname','$businessdescription','$businessphone','$businessemail','$businesswebsite','$businesswhatsapp','$businessinstagram','$businesstwitter','$businessfacebook','$businesslocation')";
...
<div class="container">
	...
	include 'header.php';
	?>
	<div align="right" style="margin: 2px; padding: 2px;" ><marquee>Welcome to SBM! Register yourself with our growing platform and start posting ads in competitive rates.</marquee></div>
		...
		<h4>Register with SBM and start uploading with your ads on our growing platform</h4>
			...
			<div class="ur_right">
					...
					<tr>
						...
						<td><textarea name="businessdescription" rows="2" cols="5" placeholder="(upto 2 lines)" maxlength="80"><?php if(isset($_GET['businessdescription'])){ $bd = $_GET['businessdescription']; echo $bd; }  ?></textarea></td>
					</tr>
