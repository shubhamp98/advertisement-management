...
if(isset($_GET['createaccount']))
{
	...
	$query = "UPDATE admin SET fname='$firstname',	lname='$lastname',	email='$email', phone='$phone',	password='$phone',		country='$country',	order_email='$email' WHERE id='$userid'";
...
<div class="container">
	...
	<div class="ar_content">
		...
		<h3><u> > Edit Profile</u><div align="center"><a href="javascript:history.back();">Go Back</a></div></h3>
				...
				<table>
					...
					<tr>
						<td colspan="2"><i><u>*Please note that by default newly registered admin permission is set to read only*</u></i></td>
