...
$query = "SELECT * FROM ads WHERE status=2"; // query for showing categories.
...
<html>
<head>
	<title>Rejected Ads - Ad Management</title>
...
<div class="ads_content">
		...
		<div  style="color: blue; font-size: 18px;" align="center"><h4> > LIST OF REJECTED ADS</h4><a class="a1" href="admin_dashboard.php#forback">Go Back</a> </div>
		<div class="uadsview">
			...
			if (mysqli_num_rows($result)>0) {
				...
				<tr class="a">
					...
					<td><a class="usrad" href="action_ads.php?aurapostid=<?php echo $rows['id']; ?> " >Approve</a></td>
				</tr>
				...
				<?php
					...
					<td align="center"><?php if($rows['status']==0){ echo "Pending";} elseif ($rows['status']==1) { echo "Approved"; } else{ echo "Rejected"; } ?> </td>
					<td><a class="usrad" href="action_ads.php?approvepostid=<?php echo $rows['id']; ?> " >Approve</a></td>
				</tr>
				...
				echo "<tr class='a'><td colspan='8' align='center'>Great! There is no rejected Ad(s) yet.</td></tr>";
			}
		...
		<div align="center" style="margin: 20px; height: 100px;  color: blue;"><i>*List of rejected ad(s) sum up here!*</i></div>
