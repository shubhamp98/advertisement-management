...
$query = "SELECT * FROM ads WHERE status=0"; // query for showing categories.
...
<html>
<head>
	<title>Pending Ads - Ad Management</title>
...
<div class="ads_content">
		...
		<div  style="color: blue; font-size: 18px;" align="center"><h4> > LIST OF PENDING ADS</h4><a class="a1" href="admin_dashboard.php#forback">Go Back</a> </div>
		<div class="uadsview">
			...
			if (mysqli_num_rows($result)>0) {
				...
				<tr class="a">
					...
					<td><a class="usrad" href="action_ads.php?aupapostid=<?php echo $rows['id']; ?> " >Approve</a>|<a class="usrad" href="action_ads.php?rupapostid=<?php echo $rows['id']; ?>">Reject</a></td>
				</tr>
				...
				<?php
					...
					<td align="center"><?php echo "(".$rows['userid'].")".$rows['posted_by'].' / '.$rows['create_date']; ?></td>
					<td align="center"><?php if($rows['status']==0){ echo "Pending";} elseif ($rows['status']==1) { echo "Approved"; } else{ echo "Rejected"; } ?> </td>
					<td><a class="usrad" href="action_ads.php?approvepostid=<?php echo $rows['id']; ?> " >Approve</a>|<a class="usrad" href="action_ads.php?rejectpostid=<?php echo $rows['id']; ?>">Reject</a></td>
				</tr>
		...
		<div align="center" style="margin: 20px; height: 100px;  color: blue;"><i>*List of pending ad(s) sum up here!*</i></div>

		<div style="margin: 20px; //border: 2px solid black;">To delete Advertisement <a href="user_ads.php">Click Here</a> and select the id and click delete.</div>
